...
public class GoogleOAuthTestHelloActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras.containsKey(EXTRA_ACCOUNTNAME)) {
            ...
            getTask(GoogleOAuthTestHelloActivity.this, mEmail, SCOPE).execute();
        }
    }
            ...
            public void run() {
                if (e instanceof GooglePlayServicesAvailabilityException) {
                    ...
                    Dialog dialog = GooglePlayServicesUtil.getErrorDialog(statusCode,
                            GoogleOAuthTestHelloActivity.this,
    ...
    private AbstractGetNameTask getTask(
            GoogleOAuthTestHelloActivity activity, String email, String scope) {
        switch (requestType) {
            case FOREGROUND:

...
public class GetNameInBackground extends AbstractGetNameTask {
    ...
    public GetNameInBackground(GoogleOAuthTestHelloActivity activity, String email, String scope) {
    ...
    private Intent makeCallback(String accountName) {
        ...
        intent.putExtra(GoogleOAuthTestHelloActivity.EXTRA_ACCOUNTNAME, accountName);
     ...
     */
    public static class GoogleOAuthTestCallbackReceiver extends BroadcastReceiver {
        public static final String TAG = "GoogleOAuthTestCallbackReceiver";

        @Override
        public void onReceive(Context context, Intent callback) {
            Bundle extras = callback.getExtras();
            Intent intent = new Intent(context, GoogleOAuthTestHelloActivity.class);
